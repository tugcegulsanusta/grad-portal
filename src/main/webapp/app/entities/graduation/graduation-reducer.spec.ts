...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GRADUATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_GRADUATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_GRADUATION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_GRADUATION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_GRADUATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_GRADUATION actions', async () => {
      const arg = 42666;
