    ...
    <div>
      ...
      <div className="table-responsive">
        {schoolList && schoolList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('universityName')}>
                  University Name <FontAwesomeIcon icon={getSortIconByFieldName('universityName')} />
                </th>
                <th className="hand" onClick={sort('facultyName')}>
                  Faculty Name <FontAwesomeIcon icon={getSortIconByFieldName('facultyName')} />
                </th>
            ...
            <tbody>
              {schoolList.map((school, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{school.universityName}</td>
                  <td>{school.facultyName}</td>
          ...
          !loading && <div className="alert alert-warning">Schools kaydi bulunamadi</div>
        )}
      </div>
      {totalItems ? (
