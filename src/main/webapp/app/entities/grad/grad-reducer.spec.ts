...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './grad.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GRAD_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_GRAD actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_GRAD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_GRAD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_GRAD actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_GRAD actions', async () => {
      const arg = 42666;
