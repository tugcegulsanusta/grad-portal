        ...
        <thead>
          <tr>
            ...
            <th className="hand" onClick={sort('login')}>
              Giriş <FontAwesomeIcon icon={getSortIconByFieldName('login')} />
            </th>
            <th className="hand" onClick={sort('email')}>
              Eposta <FontAwesomeIcon icon={getSortIconByFieldName('email')} />
            </th>
            <th />
            <th>Roller</th>
            <th className="hand" onClick={sort('createdDate')}>
              Oluşturma tarihi <FontAwesomeIcon icon={getSortIconByFieldName('createdDate')} />
            </th>
            <th className="hand" onClick={sort('lastModifiedBy')}>
              Düzenleyen <FontAwesomeIcon icon={getSortIconByFieldName('lastModifiedBy')} />
            </th>
            <th id="modified-date-sort" className="hand" onClick={sort('lastModifiedDate')}>
              Düzenleme tarihi <FontAwesomeIcon icon={getSortIconByFieldName('lastModifiedDate')} />
            </th>
            <th />
          </tr>
        </thead>
